...
void Suatchieu::themsuatchieu()
{
    ...
    cout << "Nhap ma phim can them moi: ";                  // nhập mã phim cần thêm suất chiếu mới
    string maphim;
    cin >> maphim;
    Suatchieu New;
    ...
    { // hàm kiểm tra phim muốn thêm suất chiếu có tồn tại trong danh sách movie_information hay không
        ...
        cout << "!!! Khong co thong tin phim !!!"; // nếu phim chưa tồn tại trong file movie_information thì hiện ra thông báo
}